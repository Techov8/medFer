...
public class ServiceWrapper {
    ...
    private com.techov8.medfer.ServiceInterface mServiceInterface;

    public ServiceWrapper(Interceptor mInterceptorheader) {
        mServiceInterface = getRetrofit(mInterceptorheader).create(com.techov8.medfer.ServiceInterface.class);
    }
...
//            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor();
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("https://likedealcare.000webhostapp.com/paytm_new/")
    ...
    public Call<com.techov8.medfer.Token_Res> getTokenCall(String code, String mid, String order_id, String amount) {
